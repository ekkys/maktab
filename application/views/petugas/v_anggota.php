						...
						<tbody>
							...
							foreach($anggota as $a){
								...
								<tr>
									...
									<td>
										<a target="_blank" href="<?php echo base_url('petugas/anggota_kartu/').$a->id; ?>" class="btn btn-sm btn-primary"><i
										class="fa fa-address-card"></i> Cetak Kartu</a>
										<a href="<?php echo base_url('petugas/anggota_edit/').$a->id; ?>"
											class="btn btn-sm btn-warning"><i class="fa fa-wrench"></i> Edit</a>
											<a href="<?php echo base_url('petugas/anggota_hapus/').$a->id; ?>"
