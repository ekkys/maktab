						...
						<select name="buku" class="form-control">
							...
							<?php foreach($buku as $b){ ?>
								<option value="<?php echo $b->id; ?>">
									<?php echo $b->judul. ' | '.$b->tahun. ' | ' .$b->penulis; ?>
								</option>
							<?php } ?>
						</select>
					</div>
					<div class="form-group"> <label class="font-weight-bold" for="anggota">Anggota</label>
						<select name="anggota" class="form-control">
							<option value="">- Pilih anggota</option>
							<?php foreach($anggota as $a){ ?>
								<option value="<?php echo $a->id; ?>">
									<?php echo "Nama : ". $a->nama.' | NIK : ' .$a->nik; ?>	
								</option>
							<?php } ?>
						</select>
					</div>
					<div class="form-group">
						<label class="font-weight-bold" for="tanggal_mulai">Tanggal MulaiPinjam</label>
